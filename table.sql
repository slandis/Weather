...
CREATE TABLE datum (id integer primary key, station, timestamp, conditions, tempf, tempc, winddir, winddeg, windmph, windkt, pressuremb, pressurein, dewpointf, dewpointc, windchillf, windchillc, visibility);
